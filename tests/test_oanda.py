...
def test_bulk_parser_guesses_venue() -> None:
    ...
    from alert_bot.bot.instruments import DEFAULT_EXCHANGE, _parse_bulk
...
def test_both_ways_of_adding_guess_the_same_venue() -> None:
    ...
    from alert_bot.bot import instruments as ai
...
def test_bulk_parser_tolerates_commas_and_blanks() -> None:
    from alert_bot.bot.instruments import _parse_bulk
...
def test_presets_reference_known_symbols() -> None:
    ...
    from alert_bot.bot.instruments import PRESETS
