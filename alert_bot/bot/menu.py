...
USER_COMMAND_LIST = [
    ...
    ("/add_instrument BTC/USDT", "завести свой инструмент"),
    ("/add_many BTC/USDT EURUSD", "завести несколько сразу"),
...
ADMIN_COMMAND_LIST = [
    ...
    ("/grant_admin ID", "выдать роль администратора"),
    ("/revoke_admin ID", "снять роль администратора"),
    ("/usage", "расход на модель"),
]

HELP_TEXT = (
    "<b>❓ Как это работает</b>\n\n"
    "1. Подписываетесь на нужные инструменты — кнопка «Инструменты». "
    "Нужного нет — заводите сами, там же кнопка «Добавить свой».\n"
    "2. Ставите свои уровни — кнопка «Добавить уровень».\n"
    "3. Бот следит за ценой и пишет, когда она подходит к вашей отметке.\n\n"
    "Уровни у каждого свои: чужих вы не видите, ваши не видит никто. "
    "Инструменты общие — один опрос площадки на всех подписчиков.\n\n"
    "<b>Важные детали</b>\n\n"
    ...
    "соотнести с графиком и шагает по сотым.\n\n"
    "• Уровень, от которого цена ушла дальше 3%, убирается сам — иначе список "
    "зарастает тем, что рынок давно прошёл. Об уборке приходит сообщение, "
    "история срабатываний сохраняется.\n\n"
